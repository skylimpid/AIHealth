...
from Training.constants import DATA_BASE_DIR, SYS_DIR, KAGGLE_TRAIN_DATA, KAGGLE_VALIDATE_DATA
...
__C.TRAIN_CL.EPOCHS = 60 # 80
__C.TRAIN_CL.VAL_DISPLAY_STEPS = 10
__C.TRAIN_CL.VAL_BATCH_SIZE = 1
__C.TRAIN_CL.VAL_EPOCHES_BASE = 40
__C.TRAIN_CL.VAL_EPOCHES_INC = 10
